...
function renderStepMotion(project) {
  ...
  <span>FILM · SOUND · PRINT · BOOK · 2026</span>
      ...
      <!-- CONCEPT -->
      <section class="sm-paper sm-concept" id="sm-section-1">
        <div class="shell">
      ...
      <!-- FILM -->
      <section class="sm-dark sm-film" id="sm-section-2" data-legacy-id="sm-film">
...
<section class="sm-refine-temporal" id="sm-section-3">
...
<section class="sm-refine-sound" id="sm-section-4">
  ...
  <figure class="sm-sound-timeline">
    ...
    >
      ...
      <!-- FINAL FILM -->
      <section class="sm-final-film" id="sm-section-5">
        <div class="shell">
...
<section class="sm-sequence-section sm-case-section" id="sm-section-6" data-sm-book-sequence>
...
<figure class="sm-di-frame">
        <div class="sm-di-image">
          <img
            src="${base}/book-process/colour_01.png"
...
<figure class="sm-di-frame">
        <div class="sm-di-image">
          <img
            src="${base}/book-process/colour_02.png"
...
<figure class="sm-di-frame">
        <div class="sm-di-image">
          <img
            src="${base}/book-process/colour_03.png"
...
<figure class="sm-di-frame">
        <div class="sm-di-image">
          <img
            src="${base}/book-process/colour_05.png"
...
<figure class="sm-di-frame">
        <div class="sm-di-image">
          <img
            src="${base}/book-process/colour_06.png"
...
<figure class="sm-di-frame">
        <div class="sm-di-image">
          <img
            src="${base}/book-process/colour_04.png"
    ...
    <!-- ===================================================
      ...
      <!-- BOOK INTRO -->
      <section class="sm-book-intro sm-case-section" id="sm-section-7">
        <div class="shell">
...
<section class="sm-chapter-flow" data-sm-chapter-flow>
  ...
  <div class="sm-chapter-flow-controls">
    ...
    <button type="button"
      ...
      <!-- CAPABILITIES -->
      <section class="sm-capability-section" id="sm-section-8">
        <div class="shell">
    ...
    <article class="bayer-page">
      ...
      <header
        ...
        <div class="shell bayer-hero-grid">
          ...
          <div
            class="bayer-hero-mark"
            aria-hidden="true">

            <div class="bayer-hero-symbol">
...
/* STEP MOTION — CLICKABLE SIDE NAV FIX */

function setupStepMotionSideNav(){

  if(
    !document.body.classList.contains("project-step-motion")
  ){
    return;
  }
  ...
  const resolveTarget = (el) => {
    ...
    if(explicit){
      ...
      const selectors = [
        `#${explicit}`,
        `#sm-section-${explicit}`,
        `[data-section="${explicit}"]`,
        `[data-chapter="${explicit}"]`
      ];
  ...
  console.log(
    "[Step Motion] side nav click navigation enabled"
  );
}


/*
  Run after Step Motion DOM exists.
*/
